    ...
    return (
      <section id="contact" className="min-h-screen py-20 px-4 bg-white">
        ...
        <div className="mt-6 flex justify-center gap-6">
          <a href="https://github.com/seuusuario" target="_blank" className="text-pink-600">GitHub</a>
          <a href="https://linkedin.com/in/seuusuario" target="_blank" className="text-pink-600">LinkedIn</a>
        </div>
      </section>
    )
  }